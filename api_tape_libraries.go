...
// TapeLibrariesApiService TapeLibrariesApi service
type TapeLibrariesApiService service

/*
CreateTapeLibrary Creates a new tape library.
**API Key Scope**: tape_libraries / create
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tapeLibraryBody
@return TapeLibrary
*/
func (a *TapeLibrariesApiService) CreateTapeLibrary(ctx _context.Context, tapeLibraryBody TapeLibrary) (TapeLibrary, *_nethttp.Response, error) {
	var (
...
/*
DestroyTapeLibrary Destroys a specific tape library.
**API Key Scope**: tape_libraries / destroy
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tapeLibraryId Numeric ID, serial, or name of tape library.
*/
func (a *TapeLibrariesApiService) DestroyTapeLibrary(ctx _context.Context, tapeLibraryId string) (*_nethttp.Response, error) {
	var (
...
// IndexTapeLibrariesOpts Optional parameters for the method 'IndexTapeLibraries'
...
/*
IndexTapeLibraries Lists all tape libraries.
...
*/
func (a *TapeLibrariesApiService) IndexTapeLibraries(ctx _context.Context, localVarOptionals *IndexTapeLibrariesOpts) (TapeLibraryCollection, *_nethttp.Response, error) {
	var (
...
/*
IndexTapeLibraryDevices Lists tape libraries devices.
**API Key Scope**: tape_libraries / devices
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param jobId ID of active job
@return TapeLibraryDeviceCollection
*/
func (a *TapeLibrariesApiService) IndexTapeLibraryDevices(ctx _context.Context, jobId string) (TapeLibraryDeviceCollection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
ShowTapeLibrary Displays a specific tape library.
**API Key Scope**: tape_libraries / show
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tapeLibraryId Numeric ID, serial, or name of tape library.
@return TapeLibrary
*/
func (a *TapeLibrariesApiService) ShowTapeLibrary(ctx _context.Context, tapeLibraryId string) (TapeLibrary, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UpdateTapeLibrary Updates a specific tape library.
...
@return TapeLibrary
*/
func (a *TapeLibrariesApiService) UpdateTapeLibrary(ctx _context.Context, tapeLibraryId string, tapeLibraryBody TapeLibrary) (TapeLibrary, *_nethttp.Response, error) {
	var (
